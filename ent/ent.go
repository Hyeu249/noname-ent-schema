...
func columnChecker(table string) func(string) error {
	checks := map[string]func(string) bool{
		...
		imageofuser.Table:  imageofuser.ValidColumn,
		itemhasowner.Table: itemhasowner.ValidColumn,
		order.Table:        order.ValidColumn,
		productquote.Table: productquote.ValidColumn,
		typeofgoods.Table:  typeofgoods.ValidColumn,
