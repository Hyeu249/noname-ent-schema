...
func (oc *OrderCreate) SetNillableEmail(s *string) *OrderCreate {
	if s != nil {
		oc.SetEmail(*s)
	}
	return oc
...
func (oc *OrderCreate) SetItemHasOwnerID(id uuid.UUID) *OrderCreate {
	oc.mutation.SetItemHasOwnerID(id)
	return oc
}

// SetItemHasOwner sets the "item_has_owner" edge to the ItemHasOwner entity.
func (oc *OrderCreate) SetItemHasOwner(i *ItemHasOwner) *OrderCreate {
	return oc.SetItemHasOwnerID(i.ID)
}
...
func (oc *OrderCreate) check() error {
	...
	if _, ok := oc.mutation.ItemHasOwnerID(); !ok {
		return &ValidationError{Name: "item_has_owner", err: errors.New(`ent: missing required edge "Order.item_has_owner"`)}
	}
	return nil
}
...
func (oc *OrderCreate) createSpec() (*Order, *sqlgraph.CreateSpec) {
	...
	if nodes := oc.mutation.ItemHasOwnerIDs(); len(nodes) > 0 {
		...
		_node.order_item_has_owner = &nodes[0]
